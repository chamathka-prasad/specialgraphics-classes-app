...
import uk.specialgraphics.api.SpecialgraphicsApplication;
...
//                .claim("gupType","Student")
    ...
    private static PrivateKey getPrivateKey() throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        String rsaPrivateKey = SpecialgraphicsApplication.keys.getPrivateKey();
    ...
    private static PublicKey getPublicKey() throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        String rsaPublicKey = SpecialgraphicsApplication.keys.getPublicKey();
